...
void init_adc()
{
	...
	ADC1->CFGR2 |= (4<<ADC_CFGR2_OVSS_Pos);	//set oversampling shift to 4
	ADC1->CFGR2 |= (7<<ADC_CFGR2_OVSR_Pos);	//set oversampling ratio to 256
	ADC1->CFGR2 |= ADC_CFGR2_ROVSE;			//enable oversampling

	ADC1->SMPR1 |= (7<<ADC_SMPR1_SMP5_Pos);	//Set 640.5 sampling clocks to ADC1_IN5
